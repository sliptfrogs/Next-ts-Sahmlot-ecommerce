        ...
        <div className="container-page flex h-14 items-center justify-between gap-4 lg:h-16">
          ...
          <div className="flex items-center gap-0.5">
            ...
            <Button
              ...
              size="icon"
              aria-label="Account"
              className="hidden sm:inline-flex h-9 w-9 text-foreground/70 hover:text-foreground"
            >
        ...
        <AnimatePresence>
          {activeMenu && (
            <motion.div
              ...
              animate="visible"
              exit="exit"
              className="absolute left-0 right-0 top-full hidden lg:block border-b border-border bg-background origin-top shadow-[0_24px_48px_-24px_hsl(var(--foreground)/0.18)]"
                ...
                return (
                  <div key={m.id} className="container-page py-10">
                    <div
                      className={cn(
                        "grid gap-12",
                        m.feature ? "lg:grid-cols-[1fr_320px]" : "grid-cols-1"
                      )}
                    >
                      <div
        ...
        <AnimatePresence>
          {searchOpen && (
            <motion.div
              ...
              animate="visible"
              exit="exit"
              className="border-t border-border bg-background origin-top"
            >
              <form
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.aside
            ...
            animate="visible"
            exit="exit"
            className="fixed left-0 top-0 z-drawer h-full w-[85%] max-w-[340px] bg-background flex flex-col lg:hidden shadow-card"
          ...
          >
                  ...
                  <div key={m.id} className="border-b border-border last:border-b-0">
                    ...
                    {open && (
                      <div className="pb-5 pl-4 space-y-4 animate-accordion-down">
                        {m.columns.map((col) => (
                          <div key={col.heading}>
                            <p className="text-[10px] font-semibold uppercase tracking-[0.28em] text-muted-foreground mb-2">
                              {col.heading}
                            </p>
            ...
            <div className="px-5 py-4 border-t border-border space-y-2">
              ...
              <p className="pt-2 text-[10px] text-muted-foreground tracking-wide">
